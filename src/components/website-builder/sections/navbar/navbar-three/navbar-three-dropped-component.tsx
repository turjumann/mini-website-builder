...
const NavbarThreeDroppedComponent = ({
  elementInstance,
  ...
  return (
    ...
    >
      <div className="flex items-center p-4 md:px-8 gap-10">
        <div className="text-xl font-bold">{logoText}</div>
        {/* Hamburger only for mobile/tablet */}
        <div className={cn(selectedSize === "desktop" && "hidden", "ml-auto")}>
          ☰
        </div>
...
export default NavbarThreeDroppedComponent
